...
import com.marcofranci.minhasfinancas.model.enums.TipoLancamento;
import com.marcofranci.minhasfinancas.model.repository.LancamentoRepository;
import com.marcofranci.minhasfinancas.service.LancamentoService;
...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getDescricao() == null || lancamento.getDescricao().trim().contentEquals("")) {
		...
		if (lancamento.getValor() == null || lancamento.getValor().compareTo(BigDecimal.ZERO)< 1 ) { //usado compareTo porque o valor eh bigDecimal
